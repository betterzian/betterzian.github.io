...
<img src="{$filename}/../../assets/post/FastTree-Figure4.png" alt="Figure4" style="zoom:75%;" />

不同的分组方法在不同的配置环境里效果不同。

## 决策空间

<img src="{$filename}/../../assets/post/FastTree-Figure5.png" alt="Figure5" style="zoom:75%;" />
...
<img src="./../assets/post/FastTree-equation2.png" alt="equation2" style="zoom: 33%;" />
...
<img src="{$filename}/../../assets/post/FastTree-Figure8.png" alt="figure8" style="zoom:67%;" />
...
<img src="{$filename}/../../assets/post/FastTree-Trie.png" alt="Trie" style="zoom:50%;" />

<img src="{$filename}/../../assets/post/FastTree-radix-tree.png" alt="Radix Tree" style="zoom:50%;" />
...
![algorithm]({$filename}/../../assets/post/FastTree-algorithm.png)

![proof]({$filename}/../../assets/post/FastTree-proof.png)
